...
class ActionControllerTests {
    ...
    void showMessageFormTest() throws Exception {
        ...
        verify(accessService, times(1)).getWritableServerTextChannel(member, channelId);
        verify(channel, times(1)).getName();
    }
    ...
    void sendMessageInChannelTest() throws Exception {
        ...
        verify(accessService, times(1)).getServerMember(userId, serverId);
        verify(accessService, times(1)).getWritableServerTextChannel(member, channelId);
        verify(service, times(1)).sendMessageInChannel(member, channel, content);
    }
